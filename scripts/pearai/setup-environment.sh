...
app_dir=$(pwd)
target_path="$app_dir/extensions/grapefruitide-submodule/extensions/vscode"
link_path="$app_dir/extensions/grapefruitide-ref"

# Run the base functionality
echo -e "\nInitializing sub-modules..."

# Check if the submodule directory already exists
if [ -d "$app_dir/extensions/grapefruitide-submodule" ]; then
    echo "Removing existing grapefruitide-submodule directory"
    execute "rm -rf $app_dir/extensions/grapefruitide-submodule" "Failed to remove existing grapefruitide-submodule directory"
fi
...
execute "cd ./extensions/grapefruitide-submodule" "Failed to change directory to extensions/grapefruitide-submodule"
