...
(function (AMDLoader) {
	...
	class ModuleManager {
		 ...
		 * @param pluginDependency The semi-normalized dependency that apgrapefruidIDEs in the module. e.g. 'vs/css!./mycssfile'. Only the plugin part (before !) is normalized
