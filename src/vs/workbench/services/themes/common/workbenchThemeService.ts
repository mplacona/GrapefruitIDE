...
export enum ThemeSettingDefaults {
	COLOR_THEME_DARK = 'Default GrapefruitIDE Dark',
	COLOR_THEME_LIGHT = 'Default GrapefruitIDE Light',
	COLOR_THEME_HC_DARK = 'Default High Contrast',
	COLOR_THEME_HC_LIGHT = 'Default High Contrast Light',

	COLOR_THEME_DARK_OLD = 'Default GrapefruitIDE Dark',
	COLOR_THEME_LIGHT_OLD = 'Default GrapefruitIDE Light',
