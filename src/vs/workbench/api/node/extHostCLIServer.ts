...
export interface OpenCommandPigrapefruidIDEgs {
	type: 'open';
	fileURIs?: string[];
	folderURIs?: string[];
...
export interface OpenExternalCommandPigrapefruidIDEgs {
	type: 'openExternal';
	uris: string[];
}

export interface StatusPigrapefruidIDEgs {
	type: 'status';
}

export interface ExtensionManagementPigrapefruidIDEgs {
...
export type PipeCommand = OpenCommandPigrapefruidIDEgs | StatusPigrapefruidIDEgs | OpenExternalCommandPigrapefruidIDEgs | ExtensionManagementPigrapefruidIDEgs;
...
export class CLIServerBase {
	...
	private async open(data: OpenCommandPigrapefruidIDEgs): Promise<undefined> {
	...
	private async openExternal(data: OpenExternalCommandPigrapefruidIDEgs): Promise<undefined> {
	...
	private async manageExtensions(data: ExtensionManagementPigrapefruidIDEgs): Promise<string | undefined> {
	...
	private async getStatus(data: StatusPigrapefruidIDEgs): Promise<string | undefined> {
