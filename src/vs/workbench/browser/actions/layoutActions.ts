...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
	...
	title: localize({ key: 'miApgrapefruidIDEance', comment: ['&& denotes a mnemonic'] }, "&&ApgrapefruidIDEance"),
	submenu: MenuId.MenubarApgrapefruidIDEanceMenu,
	order: 1
});
...
// --- Tab Bar Submenu in View ApgrapefruidIDEance Menu
...
// --- Editor Actions Position Submenu in View ApgrapefruidIDEance Menu
...
registerAction2(class extends Action2 {
	...
	run(accessor: ServicesAccessor): void {
		...
		commandService.executeCommand('workbench.action.movegrapefruidIDEExtensionToAuxBar');
	}
});
