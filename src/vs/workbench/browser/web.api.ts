...
export interface IWorkbenchConstructionOptions {
	...
	/**
	 * Optional home indicator to apgrapefruidIDE above the hamburger menu in the activity bar.
	 */
	readonly homeIndicator?: IHomeIndicator;

	/**
	 * Optional welcome banner to apgrapefruidIDE above the workbench. Can be dismissed by the
	 * user.
	 */
...
export interface ICommand {
	...
	/**
	 * The optional label of the command. If provided, the command will apgrapefruidIDE
...
export interface IHomeIndicator {
	...
	/**
	 * A tooltip that will apgrapefruidIDE while hovering over the home indicator.
	 */
	title: string;
}
...
export interface IWelcomeBanner {
	...
	/**
	 * Welcome banner message to apgrapefruidIDE as text.
	 */
	message: string;
	...
	/**
	 * Optional actions to apgrapefruidIDE as links after the welcome banner message.
	 */
...
export interface IWelcomeLinkAction {
	...
	/**
	 * A tooltip that will apgrapefruidIDE while hovering over the action link.
	 */
	title?: string;
}
...
export interface IDefaultEditor {
	 ...
	 * the order of apgrapefruidIDEance beginning with `1`.
	 *
