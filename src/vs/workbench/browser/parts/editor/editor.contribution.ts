...
import {
	...
	QuickAccessPreviousRecentlyUsedEditorInGroupAction, QuickAccessPreviousEditorFromHistoryAction, ShowAllEditorsByApgrapefruidIDEanceAction, ClearEditorHistoryAction, MoveEditorRightInGroupAction, OpenNextEditorInGroup,
...
import { ActiveGroupEditorsByMostRecentlyUsedQuickAccess, AllEditorsByApgrapefruidIDEanceQuickAccess, AllEditorsByMostRecentlyUsedQuickAccess } from 'vs/workbench/browser/parts/editor/editorQuickAccess';
...
quickAccessRegistry.registerQuickAccessProvider({
	ctor: AllEditorsByApgrapefruidIDEanceQuickAccess,
	prefix: AllEditorsByApgrapefruidIDEanceQuickAccess.PREFIX,
	contextKey: editorPickerContextKey,
	placeholder: localize('editorQuickAccessPlaceholder', "Type the name of an editor to open it."),
	helpEntries: [{ description: localize('allEditorsByApgrapefruidIDEanceQuickAccess', "Show All Opened Editors By ApgrapefruidIDEance"), commandId: ShowAllEditorsByApgrapefruidIDEanceAction.ID }]
});
...
registerAction2(ShowAllEditorsByApgrapefruidIDEanceAction);
