...
/**
 * Gets the escape sequence args to restore state/apgrapefruidIDEance in the cell.
 */
...
/**
 * Gets the escape sequence to restore state/apgrapefruidIDEance in the cell.
 */
